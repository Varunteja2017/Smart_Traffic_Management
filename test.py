...
speeds = {'car':2.0, 'bus':1.5, 'truck':1.5, 'rickshaw':1.6, 'bike':2.2, 'Ambulance':2.0 }  # average speeds of vehicles
...
def setTime():
    global noOfCars, noOfBikes, noOfBuses, noOfTrucks, noOfRickshaws, noOfLanes, noOfAmbulances
        ...
        for j in range(len(vehicles[directionNumbers[nextGreen]][i])):
            ...
            if(vehicle.crossed==0):
                ...
                if(vclass=='car'):
                    ...
                    noOfAmbulances +=1
    # print(noOfCars)
    greenTime = math.ceil(((noOfCars*carTime) + (noOfRickshaws*rickshawTime) + (noOfBuses*busTime) + (noOfTrucks*truckTime)+ (noOfBikes*bikeTime))/(noOfLanes+3))
...
class Main:
    ...
    pygame.display.set_caption("ROUTE_ROVERS_SIH")
